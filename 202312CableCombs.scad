...
function comb_mounting_distance(cable_count, cable_rows, cable_od, screw_od = core_hole_M3(), cable_distance = 1, outer_border = 1) = comb_width(cable_count, cable_rows, cable_od, cable_distance, outer_border) + screw_od * 2 + 1;
